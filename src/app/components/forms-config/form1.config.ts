    ...
    columns: [
        ...
        },
        {
            fields: [
                ...
                { name: 'demand_trustName', type: 'text', label: 'Trust Name', conditional: 'demand_isTrust' },
                { name: 'demand_trustAddress', type: 'text', label: 'Trust Address', conditional: 'demand_isTrust' },
                { name: 'demand_trustRegistrationNumber', type: 'text', label: 'Trust Registration Number', conditional: 'demand_isTrust' },
                { name: 'demand_trustRegistrationDate', type: 'date', label: 'Trust Registration Date', conditional: 'demand_isTrust' },
            ],
        },
        {
            fields: [
